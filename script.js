const PROJECTS = [
  ...
  { title: 'AI Digital Avatar & Voice', cat: 'ai-videos', desc: 'Accurate face reference and digital costume rendering', video: 'uaIGsRAm1es' },
  { title: 'AI Elemental VFX & Dynamics', cat: 'ai-videos', desc: 'Realistic elemental transformations and dynamics', video: '16Njb-KPAEQ' },
  { title: 'Sri Lankan AI World Concept', cat: 'ai-videos', desc: 'Futuristic AI concept set in Sri Lanka with motivational lip-sync', video: 'wpShdsMxCxU' },
  { title: 'AI Commercial Concept Ad', cat: 'ai-videos', desc: 'Professional AI-powered video advertisement', video: 'cySILlPnw2k' },
  { title: 'Cinematic AI Scenes & Motion', cat: 'ai-videos', desc: 'Advanced camera angles and fluid AI motion', video: 'iWlLIxlh3BU' },
  { title: 'AI Studio Production Showcase', cat: 'ai-videos', desc: 'High-end AI studio setting generation', video: 'm6ji0uNSUyQ' },
  { title: 'AI Cartoon & Animation', cat: 'ai-videos', desc: 'AI-powered animated cartoon storytelling', video: 'AS3cY9hVwEY' },
  { title: 'AI Short - Cinematic View', cat: 'ai-videos', desc: 'Vertical 9:16 cinematic AI short story', video: 'lRSwXxuk1NI' },
  { title: 'AI Short - Visual Effect', cat: 'ai-videos', desc: 'Quick dynamic AI VFX transformation', video: '4iItrw7ggFs' },
  { title: 'AI Short - Voice & Lip Sync', cat: 'ai-videos', desc: 'AI vocal and lip-sync integration short', video: '59uqRGE0ZEQ' },
